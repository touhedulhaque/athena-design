            ...
            <div class="container mt-5">
                <div class="row align-items-baseline">
                    <div class="col-md-5 text-center">
                        ...
                        <div className="row mt-3 pl-5 pr-5 ml-5 mr-5">
                            <div className="col-md-3">
                                <img src={facebook} alt="" width="50px" height="10px" />
                            </div>
                            <div className="col-md-3">
                                <img src={twitter} alt="" width="50px" height="10px" />
                            </div>
                            <div className="col-md-3">
                                <img src={linkedin} alt="" width="50px" height="10px" />
                            </div>
                            <div className="col-md-3">
                                <img src={dribble} alt="" width="50px" height="10px" />
                            </div>
